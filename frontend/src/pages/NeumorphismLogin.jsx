...
const NeumorphismLogin = () => {
  React.useEffect(() => {
    document.body.classList.add('neu-bg');
    return () => {
      document.body.classList.remove('neu-bg');
    };
  }, []);
    ...
    <div className="login-container">
      <div className="login-card">
        ...
        <div className="social-login">
          <button type="button" className="social-btn neu-social" title="Google">
          ...
          <button type="button" className="social-btn neu-social" title="GitHub">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button type="button" className="social-btn neu-social" title="Twitter">
            <svg viewBox="0 0 24 24" fill="currentColor">
