const CACHE_NAME = 'ubumwe-tenant-portal-v2';
const APP_SHELL = [
  '/',
  '/tenant-portal',
...
const isStaticAsset = (url) => url.pathname.startsWith('/assets/') || url.pathname.endsWith('.svg') || url.pathname.endsWith('.webmanifest');
